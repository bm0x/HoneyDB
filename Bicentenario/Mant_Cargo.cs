...
{
    public partial class Mant_Cargo : Form
    {
        String consulta;
        public Mant_Cargo()
        {
        ...
        private void Mant_Cargo_Load(object sender, EventArgs e)
        {
        ...
        private void Carga_Grilla()
        {
            try
            {
                ...
                if (Txt_Cargo.Text == "")
                {
                    consulta = "select Cod_Cargo, Desc_Cargo from Cargo order by Desc_Cargo asc";
                }
                else
                {
                    consulta = "select Cod_Cargo, Desc_Cargo from Cargo where Desc_Cargo like '%" + Txt_Cargo.Text + "%' order by Desc_Cargo asc";
                }
        ...
        private void Img_Nuevo_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            Ing_Cargo Ing_Car = new Ing_Cargo();
            Ing_Car.Show();
        }
